...
display (void)
{
  ...
  glPushMatrix ();
  gluLookAt (vettori.eye[0], vettori.eye[1], vettori.eye[2], vettori.direction[0], vettori.direction[1], vettori.direction[2], vettori.up[0], vettori.up[1], vettori.up[2]);
  drawFloor ();
  if (!aerial)
    drawCeiling ();
  drawOuterWall ();
